...
contract SocialAnalysis is UniversalContract {
    ...
    function onCall(
        ...
        emit SocialAnalysisRequested(msg.sender, "cross-chain", 0);
    }
     ...
     */
    function requestSocialAnalysis(string memory projectName) external payable requirePayment {
        ...
        emit SocialAnalysisRequested(msg.sender, projectName, msg.value);
